...
plot_title = u"Evolution of $J_{tor}$, diametral cut of tokamak's core"
...
ax1.set_title(u"Evolution of $B_r$ $(T)$, radial cut of tokamak's core", fontsize=16)
ax1.set_ylabel ("spatial space (m)", fontsize = 16*text_scale)
ax1.set_xlabel ("temporal space (s)", fontsize = 16*text_scale)
